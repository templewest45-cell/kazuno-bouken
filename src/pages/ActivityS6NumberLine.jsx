...
export default function ActivityS6NumberLine() {
  const [target, setTarget] = useState(() => randomInt(1, 10))
  ...
  function check() {
    ...
    setFeedback('correct')
    LogStore.addLog({ stage: 6, activity: 'numberline', correct: true })
  ...
  return (
    <CastleLayout title="かずの みちに おこう" instruction={`${target} の カードは どこかな？`}>
      <div className="castle-line-wrap">
        ...
        <div className="castle-numberline">
        ...
        <div className="castle-line-labels">
      ...
      {feedback === 'correct' && <CastleFooter activityId="S6_numberline" complete={complete} onNext={next} />}
    </CastleLayout>
  )
}
